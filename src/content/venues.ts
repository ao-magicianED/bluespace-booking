...
export type VenueContent = {
   ...
   * sections は「貸し会議室」「撮影スタジオ」「商談」等、
   * 検索で使われるのに本文に無かった語の受け皿となる見出し付きセクション。
   */
  seo: {
    title: string;
    description: string;
...
const COMMON_FAQS = [
  ...
  {
    q: "当日予約はできますか？",
    a: "空きがあれば利用開始の直前（1分前）までご予約いただけます。",
  },
  {
    q: "定期利用の割引はありますか？",
  ...
  {
    q: "飲食物の持ち込みはできますか？",
    a: "はい、飲食物の持ち込みは自由です。パーティーや懇親会でのケータリング利用も歓迎します。ゴミの処理は各拠点のご案内に従ってください（お持ち帰り、または拠点によって有償回収に対応）。",
  },
  {
    q: "深夜や早朝でも利用できますか？",
    a: "はい。全拠点24時間営業のため、深夜・早朝の時間帯もオンラインでそのままご予約いただけます。無人運営なので周囲を気にせずご利用いただけます。",
  },
  {
    q: "Wi-Fiはありますか？",
    a: "はい、全拠点で高速光Wi-Fiを無料でご利用いただけます。Web会議・オンライン配信にも十分な通信速度です。",
  },
];
...
export const venueContents: Record<string, VenueContent> = {
  "keisei-koiwa": {
    ...
    seo: {
      ...
      description:
        "京成小岩駅北口から徒歩30秒、JR小岩駅・新小岩エリアからもアクセスしやすい格安レンタルスペース・レンタルルーム。{price}・30分単位・24時間営業。会議・パーティー・撮影・ボードゲーム会に。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "小岩・京成小岩エリアの貸し会議室として",
          body: "ホワイトボード・プロジェクター・高速光Wi-Fiを備え、貸し会議室として会議・打ち合わせ・面接・研修にご利用いただけます。2名がけテーブル8台と椅子20脚で、少人数のミーティングから16名規模の会議まで自由にレイアウト可能。京成小岩駅から徒歩30秒なので、江戸川区内はもちろんJR小岩駅・新小岩エリアからの集合にも便利です。",
        },
        {
          title: "撮影・レンタルスタジオ利用",
          body: "約26㎡のワンフロアは撮影機材の持ち込み自由。YouTube収録・配信のほか、ロケ撮影の控室・機材置き場としての利用実績もあります。1階（B101号室）で搬入がしやすく、長時間の撮影でも30分単位で無駄なく予約できます。",
        },
        {
          title: "パーティールーム・飲食持ち込み歓迎",
          body: "最大20名収容・飲食持ち込み自由なので、誕生日会・ママ会・女子会・2次会などのパーティールームとしても人気です。80インチスクリーンとプロジェクターで映像演出やスポーツ観戦も大迫力。ゴミは有償の回収オプションで手ぶらでお帰りいただけます。",
        },
      ],
    },
    overview:
      "京成小岩駅北口から徒歩30秒のレンタルスペースです。地元の方の懇親会・ママ会・2次会・3次会から、ボードゲーム会・大画面での映画鑑賞、塾・教室・セミナー、会議・面接、撮影の控室・機材置き、配送の荷物置き、会社の一時的なオフィスまで、用途を選ばず幅広くご利用いただけます。80インチスクリーン・55インチモニター・3200ルーメンプロジェクター・Bluetoothマイクを完備し、最大20名収容対応。スペースマーケットでは4.0評価のトップホスト拠点です。",
    uses: [
      "ボードゲーム会場",
      "地元のママ会・懇親会",
      "2次会・3次会",
  ...
  kanda: {
    ...
    seo: {
      ...
      description:
        "JR神田駅東口から徒歩1分の貸し会議室・レンタルスペース。{price}・30分単位・24時間営業。会議・研修・商談・面接から、全面ミラーを活かしたダンス練習まで。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "神田の貸し会議室・研修会場として",
          body: "JR神田駅東口から徒歩1分、秋葉原駅からも徒歩8分の貸し会議室です。最大20名まで収容でき、ホーロー型ホワイトボード・SHARPモニター・BenQプロジェクター・業務用高速Wi-Fiを完備。社内会議・研修・勉強会・セミナーまで、30分単位で必要な時間だけ予約できます。",
        },
        {
          title: "商談・面接スペースとして",
          body: "駅徒歩1分・24時間営業なので、営業先との商談や採用面接、Web会議の個室としてもご利用いただけます。時間貸しの明朗価格で、空きがあれば直前まで予約可能。急な打ち合わせにも対応します。",
        },
        {
          title: "ダンス・レッスンスタジオ利用",
          body: "全面ミラーを備えたフラッグシップ拠点。ダンス練習・演劇稽古・ウォーキングレッスンなどのレンタルスタジオとして、個人練習からグループレッスンまで幅広くご利用いただけます。",
        },
      ],
    },
    overview:
      "JR神田駅東口から徒歩1分、東京メトロ銀座線・神田駅からも徒歩3分の好立地にある完全個室レンタルスペース。白を基調としたシンプルな内装は撮影との相性が良く、全面ミラー採用でダンス・稽古・ウォーキング教室にも対応します。BenQプロジェクター＋80インチスクリーン・46インチモニター・両面ホワイトボード・有線マイク・Bluetoothスピーカーなど充実の設備はすべて無料。テーブル8台・椅子20脚で最大20名着席でき、高速光WiFi（平均300Mbps）と24時間換気で配信・Web会議も快適です。設備充実のフラッグシップ拠点。",
    uses: [
      "ダンスレッスン",
      "ウォーキング教室",
      "演劇・稽古",
  ...
  "ueno-okachimachi": {
    ...
    seo: {
      ...
      description:
        "JR御徒町駅徒歩3分・上野駅徒歩6分、43㎡ワイドなレンタルスペース・貸し会議室。{price}・30分単位・24時間営業。セミナー・ママ会・誕生日会からTVロケ実績のある撮影利用まで。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "上野・御徒町の貸し会議室・セミナー会場として",
          body: "約43㎡のワイドな空間に最大20名収容。プロジェクター・大型ホワイトボード・49型テレビ・高速光Wi-Fiを備え、貸し会議室・セミナー会場・勉強会にご利用いただけます。JR御徒町駅徒歩3分・上野駅徒歩6分・末広町駅徒歩5分と、複数駅から集合しやすい立地です。",
        },
        {
          title: "ママ会・誕生日会・パーティー利用",
          body: "飲食持ち込み自由・24時間営業なので、ママ会・誕生日会・女子会・懇親会の会場としても人気です。長机と椅子のレイアウトは自由に変更でき、ゴミはスタッフ回収に対応しているので後片付けも簡単です。",
        },
        {
          title: "撮影・TVロケ実績のあるスペース",
          body: "TV番組の撮影実績がある43㎡のワイド空間。ロケ・インタビュー撮影・YouTube収録など、機材持ち込みでの撮影利用も歓迎です。マイク・スピーカーや受付ボードなどイベント運営設備も揃っています。",
        },
      ],
    },
    overview:
      "JR御徒町駅から徒歩3分。上野広小路・末広町・仲御徒町・上野御徒町を含む5駅4路線が利用でき（東京メトロ末広町駅 徒歩5分・JR上野駅 徒歩6分）、複数の駅から集合しやすい立地です。地下1階ワンフロア貸切型なので、周囲を気にせず撮影・研修・ダンス練習・ボードゲーム会に集中できます。TV番組のロケ実績があり、ビジネスプロジェクター＋80インチスクリーン・49型テレビ・ホーロー型ホワイトボード（1200×900）・有線マイクを完備。テーブル6台・椅子20脚で最大18名収容、高速WiFiは最大256台接続に対応します。インスタベースでは「清潔感・スタッフ対応」ともに高評価をいただいています。",
    uses: [
      "TV番組ロケ・撮影",
      "YouTube・TikTok収録",
      "商品撮影",
  ...
  "ueno-4a": {
    ...
    seo: {
      ...
      description:
        "JR上野駅から徒歩1分の貸し会議室・レンタルスペース。{price}・30分単位・24時間営業。会議・面接・勉強会に。隣室4Bと連結すれば最大30名の研修・セミナーにも対応。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "上野の貸し会議室として",
          body: "JR上野駅から徒歩1分の駅近貸し会議室。最大20名収容で、プロジェクター・ホワイトボード・TVモニター・業務用高速Wi-Fiを完備し、会議・打ち合わせ・面接・勉強会に最適です。エレベーターがあるので機材の搬入もスムーズです。",
        },
        {
          title: "研修・セミナー会場（4Bと連結で最大30名）",
          body: "隣室の4Bと連結してのご利用で、最大30名規模の研修・セミナーにも対応します。メイン会場とグループワーク室に分けるといった2部屋ならではの使い方も可能です。",
        },
      ],
    },
    overview:
      "JR上野駅から徒歩1分、9路線・9駅が徒歩12分圏内の駅近レンタルスペース。65インチ特大モニターと100インチプロジェクタースクリーンの2画面を備え、セミナー・研修から撮影・配信まで設備はすべて無料で使えます。隣接する4Bと連結すれば最大30名規模の研修や同時2会場開催にも対応。業務用Wi-Fiルーターで配信・Web会議も安定し、エレベーターありで機材の搬入もスムーズ、隣にコインパーキングがあるためお車も便利です。地方からの参加者でも迷わずアクセスでき、女性参加者にも配慮した立地。",
    uses: [
      "会議・打ち合わせ",
      "セミナー・研修",
      "勉強会",
    ...
    reviews: [
      {
        initial: "A",
        quote:
          "上野駅から徒歩30秒で本当にすぐ。地方からの参加者も迷わず到着できました。4Bと合わせて30名規模の研修で活用しています。",
        name: "A様",
        role: "研修事業会社",
      },
      {
  ...
  "ueno-4b": {
    ...
    seo: {
      ...
      description:
        "JR上野駅から徒歩1分、100インチ大型スクリーン搭載のレンタルスペース。{price}・30分単位・24時間営業。配信・収録・セミナー・上映会・貸し会議室に。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "上野の貸し会議室・セミナー会場として",
          body: "JR上野駅から徒歩1分。100インチの大型スクリーンで資料を大きく映せるため、セミナー・研修・プレゼンに力を発揮する貸し会議室です。隣室4Aと連結すれば最大30名規模にも対応します。",
        },
        {
          title: "配信・収録スタジオ利用",
          body: "100インチスクリーンと業務用の高速光Wi-Fiで、ウェビナー配信・YouTube収録・オンラインセミナーの会場としても人気です。撮影機材一式に対応しており、上映会やスポーツ観戦などの映像イベントにもご利用いただけます。",
        },
      ],
    },
    overview:
  ...
  "nishi-shinjuku": {
    ...
    seo: {
      ...
      description:
        "西武新宿駅徒歩7分・新宿駅徒歩10分・都庁前駅徒歩7分のビジネス特化レンタルスペース・貸し会議室。{price}・30分単位・24時間営業。商談・面接・Web会議・少人数の打ち合わせに。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "西新宿の貸し会議室として",
          body: "8名までの会議に最適な約20㎡の落ち着いた空間。TVモニター・ホワイトボード・プロジェクター・高速光Wi-Fiを備え、新宿・西新宿エリアの打ち合わせ場所として30分単位で予約できます。西武新宿駅・新宿駅・都庁前駅の3駅からアクセス可能です。",
        },
        {
          title: "商談・面接スペースとして",
          body: "営業商談・採用面接・オンライン面接の個室として、静かな環境で集中してご利用いただけます。Web会議用カメラを備え付けているためオンライン商談にもそのまま対応。24時間営業なので早朝・夜間の商談にも使えます。",
        },
      ],
    },
    overview:
  ...
  "shirokane-takanawa": {
    ...
    seo: {
      ...
      description:
        "白金高輪駅徒歩7分・高輪ゲートウェイ駅からも徒歩圏、施術ベッド対応のレンタルサロン・多目的レンタルスペース。{price}・30分単位・24時間営業。エステ・ネイル・整体・ポップアップストア・少人数会議に。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "レンタルサロン利用（エステ・ネイル・整体）",
          body: "施術ベッド（オプション）と姿見鏡・スリッパ・水回りを備えた約16㎡のプライベート空間。エステ・ネイル・まつげ・整体・占いなど、サロン開業前のお試し営業や出張施術の拠点として30分単位でご利用いただけます。白金・高輪エリアの落ち着いた環境です。",
        },
        {
          title: "少人数の会議・面接スペースとして",
          body: "白金高輪・白金・港区エリアでの少人数打ち合わせ・面接・Web会議にも。最大6名の落ち着いたスペースで、爆速のNURO光Wi-Fiとモニター・ホワイトボードを備えています。24時間営業なので時間を選ばず利用できます。",
        },
      ],
    },
    overview:
