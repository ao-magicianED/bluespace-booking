...
export const venueContents: Record<string, VenueContent> = {
  "keisei-koiwa": {
    ...
    seo: {
      ...
      sections: [
        ...
        {
          title: "ボードゲーム会の会場として",
          body: "ボードゲーム備品を備え、55インチモニターでのルール説明もできるので、ボードゲーム会・体験会の会場としてご利用いただけます。最大20名収容・飲食持ち込み自由で、長時間の遊び会も30分単位で予約できます。",
        },
        {
          title: "少人数・短時間の当日利用にも",
          body: "1〜2名での打ち合わせや作業、ちょっとした練習など、少人数・短時間の利用にも。30分単位で必要な時間だけ予約でき、空きがあれば当日・開始直前でも予約できます。京成小岩駅北口から徒歩30秒なので、思い立ったときにすぐ使えます。",
        },
      ],
    },
    overview:
  ...
  kanda: {
    ...
    contentUpdatedAt: "2026-09-25",
    seo: {
      title: "神田駅徒歩1分の貸し会議室・レンタルスペース（ダンス練習可）【{price}】｜ブルースペース神田",
      description:
        "JR神田駅東口から徒歩1分、全面ミラー付きの貸し会議室・レンタルスペース。{price}・30分単位・24時間営業。ダンス練習・稽古・レッスンから、会議・研修・商談・面接まで。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "ダンス練習・レッスンスタジオとして",
          body: "全面ミラーを備えた、JR神田駅徒歩1分のレンタルスタジオです。ダンスの自主練習やグループレッスン、演劇の稽古、ウォーキングレッスンに、30分単位で必要な時間だけご利用いただけます。Bluetoothスピーカーで音楽を流せ、24時間営業なので仕事帰りの夜や早朝の練習にも対応します。白を基調とした室内は、練習動画やSNS用の撮影にも向いています。",
        },
        {
  ...
  "ueno-okachimachi": {
    ...
    seo: {
      ...
      sections: [
        ...
        {
          title: "テレワーク・自習・作業の個室として",
          body: "1人でのテレワークや資格試験の勉強、集中したい作業の個室としてもご利用いただけます。30分単位で24時間いつでも予約でき、空きがあれば当日・開始直前でも予約可能です。高速光Wi-Fiと有線LAN（10mケーブル）で、Web会議やオンライン講座も安定して受けられます。",
        },
      ],
    },
    overview:
      "JR御徒町駅から徒歩3分。上野広小路・末広町・仲御徒町・上野御徒町を含む5駅4路線が利用でき（東京メトロ末広町駅 徒歩5分・JR上野駅 徒歩6分）、複数の駅から集合しやすい立地です。地下1階ワンフロア貸切型なので、周囲を気にせず撮影・研修・ダンス練習・ボードゲーム会に集中できます。TV番組のロケ実績があり、ビジネスプロジェクター＋80インチスクリーン・49型テレビ・ホーロー型ホワイトボード（1200×900）・有線マイクを完備。テーブル6台・椅子20脚で最大20名（18名での利用が最適）、高速WiFiは最大256台接続に対応します。インスタベースでは「清潔感・スタッフ対応」ともに高評価をいただいています。",
    uses: [
      "TV番組ロケ・撮影",
      "YouTube・TikTok収録",
      "商品撮影",
  ...
  "ueno-4a": {
    ...
    seo: {
      ...
      sections: [
        ...
        {
          title: "早朝・始業前の会議や研修に",
          body: "24時間営業なので、始業前の朝会議や、早朝から始まる研修・勉強会にもご利用いただけます。JR上野駅から徒歩1分の駅前立地で、遠方からの参加者も迷わず集まれます。",
        },
        {
          title: "歓迎会・送別会・懇親会に",
          body: "飲食物の持ち込みは自由で、ケータリングを使った歓迎会・送別会・打ち上げ・懇親会の会場としてもご利用いただけます。65インチモニターと100インチスクリーンでスライドショーや動画の上映もでき、ゴミの持ち帰りは不要です（スタッフ対応）。",
        },
      ],
    },
    overview:
  ...
  "ueno-4b": {
    ...
    seo: {
      ...
      sections: [
        ...
        {
          title: "テレワーク・作業スペースとして",
          body: "JR上野駅徒歩1分の個室で、テレワーク・資料作成・オンライン会議などの作業にもご利用いただけます。業務用ルーターの高速光Wi-Fiを備え、30分単位で必要な時間だけ、空きがあれば当日・開始直前でも予約できます。",
        },
      ],
    },
    overview:
  ...
  "nishi-shinjuku": {
    ...
    name: "ブルースペース西新宿403",
    badge: "新宿主要3駅アクセス",
    station: "西新宿駅 徒歩4分 / 西武新宿駅 徒歩7分 / 新宿駅 徒歩10分",
    ...
    seo: {
      ...
      description:
        "西新宿駅徒歩4分・西武新宿駅徒歩7分・新宿駅徒歩10分・都庁前駅徒歩7分のビジネス特化レンタルスペース・貸し会議室。{price}・30分単位・24時間営業。商談・面接・Web会議・少人数の打ち合わせに。公式予約なら仲介手数料なし。",
      sections: [
        {
          title: "西新宿の貸し会議室として",
          body: "8名までの会議に最適な約20㎡の落ち着いた空間。TVモニター・ホワイトボード・プロジェクター・高速光Wi-Fiを備え、新宿・西新宿エリアの打ち合わせ場所として30分単位で予約できます。西新宿駅（徒歩4分）・西武新宿駅・新宿駅・都庁前駅の4駅からアクセス可能です。",
        },
        {
          title: "当日・夜間の会議や打ち合わせに",
          body: "24時間営業で、空きがあれば開始直前まで予約できるため、急な打ち合わせや夜間の会議にも対応します。8名最適・最大12名の完全個室で、西新宿駅・新宿駅・西武新宿駅・都庁前駅から歩いて集まれます。",
        },
        {
          title: "商談・面接スペースとして",
        ...
        {
          title: "動画撮影・クロマキー撮影に",
          body: "クロマキー合成用のグリーンスクリーンと55インチ大型モニター・Webカメラを備え、動画撮影・オンライン配信・プロフィール撮影にご利用いただけます。",
        },
      ],
    },
    overview:
    ...
    accessRows: [
      { label: "最寄り駅", main: "東京メトロ丸ノ内線「西新宿駅」", sub: "徒歩4分" },
      { label: "副駅1", main: "西武新宿線「西武新宿駅」", sub: "徒歩7分" },
      { label: "副駅2", main: "都営大江戸線「都庁前駅」", sub: "徒歩7分" },
      { label: "副駅3", main: "JR・各線「新宿駅」", sub: "徒歩10分" },
    ...
    faqs: [
      ...
      {
        q: "最寄り駅はどこですか？",
        a: "東京メトロ丸ノ内線「西新宿駅」から徒歩4分、西武新宿駅・都営大江戸線「都庁前駅」から徒歩7分、新宿駅から徒歩10分です。",
      },
    ],
    mapEmbedSrc:
  ...
  "shirokane-takanawa": {
    ...
    address: "東京都港区白金3-1-12 第二浅野ビル301号室",
    postalCode: "108-0072",
    addressLocality: "港区",
    ...
    seo: {
      ...
      sections: [
        ...
        {
          title: "テレワーク・少人数の勉強会に",
          body: "NURO光Wi-Fiとモニター・ホワイトボードを備えた個室で、1人でのテレワークや作業、少人数の勉強会・個別指導にも30分単位でご利用いただけます。",
        },
      ],
    },
    overview:
    ...
    accessRows: [
      ...
      { label: "住所", main: "東京都港区白金3-1-12", sub: "第二浅野ビル301号室" },
    ],
