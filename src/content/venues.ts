...
export const venueContents: Record<string, VenueContent> = {
  "keisei-koiwa": {
    ...
    seo: {
      ...
      description:
        "京成小岩駅北口から徒歩30秒、JR小岩駅・新小岩エリアからもアクセスしやすい格安レンタルスペース・レンタルルーム。{price}・30分単位・24時間営業。会議・パーティー・撮影・ボードゲーム会に。公式予約なら仲介手数料なしの最安価格。",
      sections: [
        {
  ...
  kanda: {
    ...
    seo: {
      ...
      description:
        "JR神田駅東口から徒歩1分の貸し会議室・レンタルスペース。{price}・30分単位・24時間営業。会議・研修・商談・面接から、全面ミラーを活かしたダンス練習まで。インスタベース東京都1位の人気拠点。公式予約なら仲介手数料なし。",
      sections: [
        {
