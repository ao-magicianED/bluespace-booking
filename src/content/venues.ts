...
export const venueContents: Record<string, VenueContent> = {
  ...
  "nishi-shinjuku": {
    ...
    seo: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "24時間営業で、空きがあれば開始直前まで予約できるため、急な打ち合わせや夜間の会議にも対応します。8名最適・最大12名の完全個室で、新宿駅・西武新宿駅・都庁前駅から歩いて集まれます。",
        },
        {
          title: "商談・面接スペースとして",
    ...
    accessRows: [
      ...
      { label: "副駅3", main: "東京メトロ丸ノ内線「西新宿駅」", sub: "約350m" },
    ...
    faqs: [
      ...
      {
        q: "最寄り駅はどこですか？",
        a: "東京メトロ丸ノ内線「西新宿駅」から約350m、西武新宿駅・都営大江戸線「都庁前駅」から徒歩7分、新宿駅から徒歩10分です。",
      },
    ],
    mapEmbedSrc:
