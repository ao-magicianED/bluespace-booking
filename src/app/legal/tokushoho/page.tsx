      ...
      <table className="legal-table">
        <tbody>
          ...
          <tr>
            <th>支払時期</th>
            <td>
              クレジットカード: 予約手続き時にお支払いが確定します
              <br />
              請求書払い: 発行した請求書に記載の期限（申込の翌営業日18:00まで。連休を挟む場合など、これより早い期限となる場合があります。かつ利用開始の24時間前まで、いずれか早い時点）までにお振込みください。正確な期限は予約時の画面および請求書に表示されます
            </td>
          </tr>
          <tr>
            <th>役務の提供時期</th>
