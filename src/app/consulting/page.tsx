...
const MARKET_ROWS = [
  ...
  },
  {
    ...
    label: "費用",
    self: "400,000円〜(税別)",
    others: ["450,000円(税別)", "200,000円(税別)", "入会金 3,980円"],
  },
  {
    label: "支援期間",
    self: "3〜6ヶ月",
    others: ["開業前〜開業2ヶ月後", "公開情報に記載なし", "―"],
  },
  {
    label: "公開情報に記載のある支援範囲",
    self: "物件探し・内装/デザイン方向性・撮影・集客導線構築。希望に応じて開業後の運営代行まで",
    others: [
      "エリアリサーチ・物件探し・選定/交渉・内装アドバイス・掲載サポート・運営指導(撮影は別料金)",
      "物件選定アドバイス・コンセプト設計・レイアウト/内装提案・無人運営の立ち上げ指導",
